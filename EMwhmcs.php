	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'separator' => 'before',
				'description' => __( 'the apiIdentifier from WHMCS: https://docs.whmcs.com/API_Authentication_Credentials', 'text-domain' ),
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'separator' => 'before',
				'description' => __( 'the apiSectet from WHMCS: https://docs.whmcs.com/API_Authentication_Credentials', 'text-domain' ),
			]
		);
